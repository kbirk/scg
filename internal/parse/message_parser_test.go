...
func TestMessageParser(t *testing.T) {
	...
	assert.Equal(t, uint32(14), message.Fields["n"].Index)
	...
	assert.Equal(t, uint32(15), message.Fields["o"].Index)
	...
	assert.Equal(t, uint32(16), message.Fields["p"].Index)
	...
	assert.Equal(t, uint32(17), message.Fields["q"].Index)
	...
	assert.Equal(t, uint32(18), message.Fields["r"].Index)
