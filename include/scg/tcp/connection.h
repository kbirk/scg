...
struct TCPContext {
    ...
    TCPContext() : work_guard(asio::make_work_guard(io_context)) {}
};

class TCPConnection : public rpc::Connection, public std::enable_shared_from_this<TCPConnection> {
public:
    TCPConnection(asio::ip::tcp::socket socket, bool noDelay = true)
