...
var (
	...
	ResponsePrefix = [16]byte{
		...
		0x72, 0x65, 0x73, 0x70,
		0x6F, 0x6E, 0x73, 0x65}
	StreamOpenPrefix = [16]byte{
		0x00, 0x00, 0x00, 0x00,
		0x73, 0x63, 0x67, 0x2D,
		0x73, 0x74, 0x72, 0x6D,
		0x2D, 0x6F, 0x70, 0x6E} // "scg-strm-opn"
	StreamMessagePrefix = [16]byte{
		0x00, 0x00, 0x00, 0x00,
		0x73, 0x63, 0x67, 0x2D,
		0x73, 0x74, 0x72, 0x6D,
		0x2D, 0x6D, 0x73, 0x67} // "scg-strm-msg"
	StreamResponsePrefix = [16]byte{
		0x00, 0x00, 0x00, 0x00,
		0x73, 0x63, 0x67, 0x2D,
		0x73, 0x74, 0x72, 0x6D,
		0x2D, 0x72, 0x73, 0x70} // "scg-strm-rsp"
	StreamClosePrefix = [16]byte{
		0x00, 0x00, 0x00, 0x00,
		0x73, 0x63, 0x67, 0x2D,
		0x73, 0x74, 0x72, 0x6D,
		0x2D, 0x63, 0x6C, 0x73} // "scg-strm-cls"
)
